...
urlpatterns = [
    ...
    path("invoices/autosave/", views.invoice_autosave, name="invoice_autosave_new"),
    path("invoices/<uuid:invoice_id>/autosave/", views.invoice_autosave, name="invoice_autosave"),
